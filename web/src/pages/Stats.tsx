...
type Stats = {
  ...
  /** Anonymous count of people who saw the landing page. */
    ...
    <Screen className="pb-12">
      ...
      <div className="mt-6 grid grid-cols-4 gap-2">
        <div className="rounded-lg bg-card p-3 text-center">
          <p className="tabular text-2xl font-extrabold text-foreground">{data.landingVisits}</p>
          <p className="mt-0.5 text-xs text-muted-foreground">Landing</p>
        </div>
        <div className="rounded-lg bg-card p-3 text-center">
